...
function Classifier_2
    ...
    Fraction_factors = inputdlg('Quality Factor', 'Fraction Factors', [1 100],{'177.00'});
...
function Classifier_1
    ...
    Fraction_factors = inputdlg('Speed Factor', 'Fraction Factors', [1 100],{'0.74'});
    tracks_combined = importdata(filename_tracks_combined);
...
function Training_data
    ...
    for i = 1:num_tracks
        ...
        for k = vec_read(1):vec_read(end)
         ...
         h1.Visual.setPropertyValue('DataRangeMin',70);
         h1.Visual.setPropertyValue('DataRangeMax',350);
