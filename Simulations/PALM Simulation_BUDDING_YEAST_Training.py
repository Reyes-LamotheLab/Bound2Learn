...
filename = 'Yeast_Training_AFAP_02_slowD1.tif'
pixels = 500
...
cell_background =0.2 # Default = 0.2Cell_bg_intensity/int_steps
...
for u in range(num_bacteria):
    ...
    for w in range(track_numbers):
        ...
        z_origin = 0
        z_init = rnd.randrange(yst_zmin, yst_zmax)#rnd.randrange(yst_zmin, yst_zmax)
