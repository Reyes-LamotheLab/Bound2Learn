%% **
function Trackmate_ML_batch_FINAL_REVISED_Simulations
...
function Classifier_2
    ...
    Fraction_factors = inputdlg('Quality Factor', 'Fraction Factors', [1 100],{'250.0'});
...
function Classifier_1
    ...
    Fraction_factors = inputdlg('Speed Factor', 'Fraction Factors', [1 100],{'0.71'});
    tracks_combined = importdata(filename_tracks_combined);
