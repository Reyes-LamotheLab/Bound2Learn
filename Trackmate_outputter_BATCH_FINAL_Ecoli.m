...
filenames_images = uigetfile('*binary*.tif', 'Pick Binary Image Files', 'Multiselect', 'on');
...
folder_save = strcat('Ecoli','_','Time_Int',num2str(user_input_tracks{1}),'_','datpt_',num2str(user_input_tracks{2}),'_','Spt_Thr_', num2str(user_input_tracks{6}));
mkdir(folder_save);
