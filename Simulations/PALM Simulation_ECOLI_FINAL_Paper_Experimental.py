...
filename = 'Ecoli_Exp_0.100s_fastD_03.tif'
pixels = 500
...
w1 = 0.7
w2 = 1-w1
params_array = [interval_frame, camera_exposure,Cell_bg_intensity, Tbleach,Tunbind,Tbind,D1,D2, int_fluorophore, w1]
params_array_num = npy.array(params_array)
dat_df = pd.DataFrame(params_array_num)
dat_df_Tr = dat_df.T
columns_nam = ['Interval(frames)', 'Camera Exposure', 'Cell Background Intensity', 'Tbleach', 'Bound Time', 'Search Time', 'Fast Moving D', 'Bound D', 'IntFluorophore', 'Weight D1']
